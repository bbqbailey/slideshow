...
# - Sequence (per cycle of frames):
#       12 photo images  ->  TIME  ->  WEATHER  ->  RADAR1  ->  RADAR2  ->  SECURITY x6
...
display_logger.info("=== DISPLAY LOG STARTED (V2-2 MJPEG + RADAR + WEATHER + SECURITY) ===")
...
def generate_security_frames_in_order():
    ...
    for subdir in SECURITY_CAMERA_SUBDIRS_IN_ORDER:
        ...
        # Convert to JPEG bytes (uses same EXIF + error placeholder semantics)
...
class SlideshowHTTPRequestHandler(SimpleHTTPRequestHandler):
    ...
    def get_html_content(self):
        ...
        <head>
            <meta charset="UTF-8">
            <title>Slideshow V2-2 MJPEG + RADAR + WEATHER + SECURITY</title>
            <style>
                html, body {
...
def run_server(port=8000):
    ...
    logging.info(f"Server on port {port} (V2-2 MJPEG + RADAR + WEATHER + SECURITY, threaded)")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Slideshow V2-2 — Recursive Photo Viewer with MJPEG push stream, weather panel, radar.weather.gov ridge frames, and security camera frames",
